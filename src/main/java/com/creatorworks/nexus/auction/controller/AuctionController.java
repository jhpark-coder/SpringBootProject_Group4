...
public class AuctionController {
    ...
    // 문의 관련 엔드포인트 추가
    @PostMapping("/auctions/{id}/inquiries")
    public String createInquiry(@PathVariable Long id, 
                               @ModelAttribute AuctionInquiryRequestDto requestDto,
                               Principal principal) {
        String userEmail = principal.getName();
        auctionInquiryService.createInquiry(id, requestDto, userEmail);
        return "redirect:/auctions/" + id;
    }

    @PostMapping("/auctions/{id}/inquiries/{inquiryId}/replies")
    public String createReply(@PathVariable Long id,
                             @PathVariable Long inquiryId,
                             @ModelAttribute AuctionInquiryRequestDto requestDto,
                             Principal principal) {
        String userEmail = principal.getName();
        auctionInquiryService.createReply(id, inquiryId, requestDto, userEmail);
        return "redirect:/auctions/" + id;
    }
